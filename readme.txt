...
Zemanta is a WordPress plugin that integrates Zemanta's web service to make it easy to add contextual images, articles, links and tags to your post.
...
1. Write page with plugin turned on, but with no content yet.
